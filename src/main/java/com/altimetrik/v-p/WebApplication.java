...
import com.altimetrik.v-p.filter.ApiOriginFilter;
...
@EntityScan("com.altimetrik.v_p.models")
@EnableJpaRepositories("com.altimetrik.v_p.models.repository")
